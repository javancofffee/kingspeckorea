...
<div class="item-icon">
	<div class="pull-right">
		<div class="form-group">
			...
			<?php if(!empty($it['it_1'])){ //링크값이 있다면 2016-12-09 by nuki?>
				<a href="<?php echo $it['it_1'];?>" target="_blank" class="btn btn-<?php echo $btn2;?> btn-sm"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">주문하러가기</span></a>
			<?php } else { ?>
				<a href="javascript:;" onclick="alert('상품 입고 대기중 입니다.\n문의 사항은 1:1문의 게시판 이용 부탁 드립니다.');" target="_blank" class="btn btn-<?php echo $btn2;?> btn-sm"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">주문하러가기</span></a>
			<?php } ?>
			<?php } ?>
		</div>
	</div>
