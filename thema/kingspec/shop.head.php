...
<div id="thema_wrapper" class="wrapper <?php echo $is_thema_layout;?> <?php echo $is_thema_font;?>">
	...
	<aside class="at-lnb">
		<div class="at-container">
			...
			<div class="pull-left">
				<ul>
					<li><a href="http://www.kingspec.com.cn/"><b>CHINESE</b></a></li>
					<li><a href="javascript:;" id="favorite"><b>즐겨찾기</b></a></li>
					<li><a href="<?php echo $at_href['rss'];?>" target="_blank"><b>RSS 구독</b></a></li>
					<?php
					  $tweek = array("일", "월", "화", "수", "목", "금", "토");
					?>	
					<li><a><b><?php echo date('m월 d일');?>(<?php echo $tweek[date("w")];?>)</b></a></li>
				</ul>
			</div>
			<!-- LNB Right -->
			<div class="pull-right">
				<ul>
					...
					<?php } else { // 로그아웃 상태 ?>
						<li><a href="<?php echo $at_href['login'];?>" onclick="sidebar_open('sidebar-user'); return false;">관리자로그인</a></li>
	...
	<!--	<div class="at-container">
			...
			<div class="header-logo">
				<a href="<?php echo $at_href['home'];?>">
					<img src="/kingspec/home//logo.png" border=0>
				</a>
